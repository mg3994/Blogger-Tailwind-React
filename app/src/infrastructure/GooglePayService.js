...
export class GooglePayService {
    ...
    merchantName = "Antinna";
    async initPayment(order, verifiedLocation) {
        ...
        const displayItems = [];
        SchemaExtractor.getArray(order.orderedItem).forEach((item) => {
            ...
            SchemaExtractor.getArray(item.addOns).forEach((addon) => {
